...
const Callback = ({setAuthorized})=>{
    ...
    return(
        ...
        <Modal
    show="true"
    onClose={()=>{   setAuthorized(true);
        navigate('/', { replace: true });}}
  >
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 py-5">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" onClick={()=>{   setAuthorized(true);
                navigate('/', { replace: true });}}>
